<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-purple-300">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/hackalonglogo1.png" class="w-40" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/hackalonglogo.png" class="w-40" alt="logo" /></g-link>
        </div>
    ...
    <footer class="bg-purple-500 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>Copyleft {{ new Date().getFullYear() }}. Creative commons non-attribution.</div>
        </div>
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a href="https://www.youtube.com/channel/UCD3nTmq-AC1H7T5J7cRwoVA/featured" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/hack-along" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/hackalongio" target="_blank" class="text-white hover:text-gray-400">
